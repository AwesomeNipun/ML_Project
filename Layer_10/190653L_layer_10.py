# -*- coding: utf-8 -*-
"""190653L_Layer_10.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/19sXA3yzzWmP9Htt1ajG5jusYyrmtBbMB
...
# # save label_1 output to label_1.csv
# y_pred = best_models['label_1'].predict(pca_test['label_1'])
# y_pred = pd.DataFrame(y_pred, columns=['label_1'])
# y_pred.to_csv('label_1.csv', index=False)
...
# # save label_1 output to label_2.csv
# y_pred = best_models['label_2'].predict(pca_test['label_2'])
# y_pred = pd.DataFrame(y_pred, columns=['label_2'])
# y_pred.to_csv('label_2.csv', index=False)
...
# # save label_1 output to label_3.csv
# y_pred = best_models['label_3'].predict(pca_test['label_3'])
# y_pred = pd.DataFrame(y_pred, columns=['label_3'])
# y_pred.to_csv('label_3.csv', index=False)
...
# # save label_1 output to label_4.csv
# y_pred = best_models['label_4'].predict(pca_test['label_4'])
# y_pred = pd.DataFrame(y_pred, columns=['label_4'])
# y_pred.to_csv('label_4.csv', index=False)
...
result_.to_csv('layer_10.csv', index=False)
